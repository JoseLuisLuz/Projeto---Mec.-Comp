...
fileID0 = fopen("NOSfem1T6Entalhe.txt", "r");
fileID1 = fopen("ELEMfem1T6Entalhe.txt", "r");
formatSpec = '%c'; '%d';
...
sigmayy_no1 = sigmayy_no1/numel(elem_no1);
...
if ponto_2_on == true
    ...
    sigmayy_no2 = sigmayy_no2/numel(elem_no2);
...
sigmayy_no3 = sigmayy_no3/numel(elem_no3);
...
if ponto_2_on == true
    com4no2 = [num2str(Energ_Def_El_no2),' mJ/mm^3'];
end
